        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 p-8 flex-col justify-between">
            <div>
              ...
              <p className="mt-2 text-indigo-300">Empower your future with skills</p>
            </div>
            <div className="my-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-200">10,000+ courses</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-indigo-500 text-white flex items-center justify-center font-bold text-sm">✓</div>
                  <span className="text-gray-200">Expert instructors</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-indigo-500 text-white flex items-center justify-center font-bold text-sm">✓</div>
                  <span className="text-gray-200">Certification & placement</span>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-indigo-300 mt-1">Sign in to continue your journey</p>
            </div>
