            ...
            <div className="my-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-800">Access 10,000+ courses</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">✓</div>
                  <span className="text-gray-800">Learn from industry experts</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">✓</div>
                  <span className="text-gray-800">Get certified & placed</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-5">
                <div className="relative">
                  <input
                    ...
                    value={otp}
                    onChange={(e) => setOtp(e.target.value)}
                    className="peer w-full px-4 pt-6 pb-2 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition text-center text-2xl tracking-widest"
                    placeholder=" "
                    maxLength="6"
                    required
                  />
                ...
                <p className="text-xs text-center text-gray-500">Sent to {formData.email}</p>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={handleVerify}
                ...
                <button
                  onClick={() => setStep('register')}
                  className="w-full text-sm underline text-gray-500 hover:text-gray-700"
                >
                  Back to signup
                </button>
              </div>
