  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] px-4">
      <motion.div 
        ...
        className="w-full max-w-md rounded-2xl shadow-xl bg-[#1E293B]/80 backdrop-blur-sm border border-indigo-500/20"
      >
        <div className="p-6 sm:p-10">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white">Create new password</h1>
            <p className="text-sm mt-1 text-indigo-300">Enter OTP and your new password</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="relative">
              <input 
                ...
                value={email} 
                disabled 
                className="w-full px-4 py-3 rounded-xl border border-indigo-500/30 bg-[#0F172A] text-gray-300 opacity-80"
              />
            </div>
            <div className="relative">
              <input 
                ...
                className="peer w-full px-4 pt-6 pb-2 rounded-xl border border-indigo-500/30 bg-[#0F172A] text-white focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 outline-none transition" 
                placeholder=" " 
                required 
              />
              <label htmlFor="otp" className="absolute left-4 top-1 text-sm text-indigo-300 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-sm">
                6-digit OTP
              </label>
            </div>
            <div className="relative">
              <input 
                ...
                required 
              />
              <label htmlFor="newPassword" className="absolute left-4 top-1 text-sm text-indigo-300 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-sm">
                New password
              </label>
            </div>
            <div className="relative">
              <input 
                ...
                required 
              />
              <label htmlFor="confirmPassword" className="absolute left-4 top-1 text-sm text-indigo-300 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-sm">
                Confirm password
              </label>
            </div>
            <motion.button 
              ...
              type="submit" 
              disabled={loading} 
              className="w-full py-3 rounded-xl font-semibold bg-indigo-600 text-white hover:bg-indigo-700 transition disabled:opacity-70"
            >
              {loading ? 'Resetting...' : 'Reset Password'}
            </motion.button>
          </form>
