        ...
        <div className="p-6 sm:p-10">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="relative">
                <input
                  ...
                  required
                />
                <label htmlFor="email" className="absolute left-4 top-1 text-sm text-indigo-300 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-sm">
                  Email address
                </label>
              </div>
              <motion.button 
            ...
            <div className="text-center">
              <p className="mb-4 text-gray-300">We've sent a 6-digit OTP to <strong className="text-indigo-400">{email}</strong></p>
              <motion.button 
                whileHover={{ scale: 1.02 }} 
                whileTap={{ scale: 0.98 }} 
          ...
          <p className="text-center text-sm mt-8 text-gray-400">
            Remember password? <Link to="/login" className="font-semibold text-indigo-400 hover:text-indigo-300 transition">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
