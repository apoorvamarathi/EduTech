  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] px-4">
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-md rounded-2xl shadow-xl overflow-hidden bg-[#1E293B]/80 backdrop-blur-sm border border-indigo-500/20"
      >
        <div className="p-6 sm:p-10">
          <div className="text-center mb-8">
          ...
          {!submitted ? (
            ...
            <div className="text-center">
              <p className="mb-4 text-gray-300">We've sent a 6-digit OTP to <strong className="text-indigo-300">{email}</strong></p>
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
