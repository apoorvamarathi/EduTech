  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto text-center space-y-6">
        ...
        <p className="text-gray-300">Something went wrong. Your payment could not be processed.</p>
        <div className="flex gap-4 justify-center">
          <Link to="/cart" className="px-6 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition">Retry Payment</Link>
          <Link to="/contact" className="px-6 py-2 rounded-lg border border-indigo-500/30 text-gray-200 hover:bg-indigo-500/10 transition">Contact Support</Link>
        </div>
      </div>
    </Layout>
  );
